...
from apps.auth.permissions import AuthenticatedUserOrNone
...
def prefectures(user: AuthenticatedUserOrNone):
    """
...
def municipalities(user: AuthenticatedUserOrNone, code: str = Query(None, description="Prefecture code")):
    """
